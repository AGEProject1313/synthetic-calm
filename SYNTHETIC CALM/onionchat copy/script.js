...
function getJavierMenu(menuKey) {
    const menus = {
        ...
        interrogate: {
            ...
            options: [
                ...
                },
                {
                    ...
                    requestType: "interrogate",
                    target: "Sofia Mirel",
                    requiresProgress: "sm4418_linked_to_sofia",
                    disabledIfAnyProgress: [
        ...
        inspect: {
            text: "Elijan el lugar. Si está bajo control de Veyra, voy a necesitar tiempo y discreción.",
            translation: "Choose the location. If it is under Veyra control, I will need time and discretion.",
            options: [
                { label: "Nathan Residence", action: "request", requestType: "inspect", target: "Nathan Residence" },
                { label: "Food Hall", action: "request", requestType: "inspect", target: "Food Hall" },
                { label: "Eiden Cinema", action: "request", requestType: "inspect", target: "Eiden Cinema" },
                { label: "Lake Pavilion / MatchPoint", action: "request", requestType: "inspect", target: "Lake Pavilion / MatchPoint" },
                { label: "Command Nexus", action: "request", requestType: "inspect", target: "Command Nexus" },
                { label: "Server Farm Alpha", action: "request", requestType: "inspect", target: "Server Farm Alpha" },
                { label: "The Silence Zone", action: "request", requestType: "inspect", target: "The Silence Zone" },
                { label: "Legacy Infrastructure Node", action: "request", requestType: "inspect", target: "Legacy Infrastructure Node" },
                { label: "BACK", action: "submenu", target: "main" }
            ]
        },
        documents: {
